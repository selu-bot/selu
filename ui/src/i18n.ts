export const translations = {
  en: {
    ...
    loading: 'Loading', mainNavigation: 'Main navigation', manage: 'Manage', memory: 'Memory', mobileApp: 'Mobile app',
  ...
  de: {
    ...
    loading: 'Wird geladen', mainNavigation: 'Hauptnavigation', manage: 'Verwalten', memory: 'Erinnerungen', mobileApp: 'Mobile App',
