...
export const translations = {
  en: {
    ...
    todayWithSelu: 'Today with Selu', todayTimelineHint: 'Completed conversations and results flow into what Selu will handle next.', now: 'Now',
  ...
  de: {
    ...
    todayWithSelu: 'Heute mit Selu', todayTimelineHint: 'Erledigte Unterhaltungen und Ergebnisse gehen direkt in Selus nächste Aufgaben über.', now: 'Jetzt',
