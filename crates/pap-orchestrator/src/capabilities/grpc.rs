...
pub mod pap_capability {
    tonic::include_proto!("pap.capability.v1");
}
...
use pap_capability::capability_client::CapabilityClient;
use pap_capability::{InvokeRequest, InvokeChunk};
