...
pub struct Thread {
    ...
    /// The GUID of Selu's last outbound reply in this thread.
...
/// Maps an external sender identity (phone number, email, etc.) to a Selu user
...
pub struct InboundEnvelope {
    ...
    pub text: String,
    /// Optional inbound attachments (for channels that support media/file ingress)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub attachments: Option<Vec<InboundAttachment>>,
...
pub struct InboundAttachment {
    ...
    /// Optional short-lived URL to download the attachment
    #[serde(skip_serializing_if = "Option::is_none")]
    pub download_url: Option<String>,
    /// Optional inline payload for adapters that cannot provide download URLs
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct OutboundEnvelope {
    ...
    /// Optional outbound attachments (for channels that support file delivery)
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct OutboundAttachment {
    /// Selu artifact ID for correlation/debugging
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub download_url: Option<String>,
    /// Optional inline payload for adapters that cannot fetch download URLs
    #[serde(skip_serializing_if = "Option::is_none")]
    pub data_base64: Option<String>,
}
