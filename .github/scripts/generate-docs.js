...
${styleGuide || "No style guide available. Use clear, warm, accessible language. Use Starlight-compatible MDX with frontmatter."}
...
${currentDocs || "No existing documentation found for the affected sections. Create new pages."}
